...
# Rust Notes
TODO: Refine this once the rust codebase is far enough along

## Rust Coverage Testing
A coverage report can be generated by running `cargo xtask coverage`. The report will be
stored in `./coverage/html/index.html`.

## Rust Build Dependencies
Build dependencies:
* Install the rust toolchain according to the instructions at https://rustup.rs/.
